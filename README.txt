...
--> project_1: the package of the project, that contains:
	 ...
	 -the launche folder with the .launch file
	 -the msg folder with the floatStamped.msg file and the odom_cm.msg file (used to 		  publish the odometry)
	 -the cfg folder, with the parameters.cfg file (used in the dynamic 		  
          reconfiguration)
...
How to execute the code : 
	- run one of the bags
	- in a separate terminal, run the node with " rosrun project_1 odometry "
